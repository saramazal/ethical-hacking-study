...
| Command                                                       | Description                                     |
|---------------------------------------------------------------|-------------------------------------------------|
| `ftp $TARGET_IP`                                           | Connecting to the FTP server using the ftp client. |
| `nc -v $TARGET_IP 21`                                      | Connecting to the FTP server using netcat.         |
| `hydra -l user1 -P /usr/share/wordlists/rockyou.txt ftp://$TARGET_IP` | Brute-forcing the FTP service.                     |
